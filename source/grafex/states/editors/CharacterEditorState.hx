...
// The begining mouse location that all drag movements are in reference of
	...
	override function create()
	{
		...
		\nDrag Chars with your mosue to add offsets\n".split('\n');
	...
	function addIconUI() {
        ...
        iconOffsetY = new FlxUINumericStepper(280, decideIconColor.y + 30, 5, 0, -500, 500, 0);
		getEvent(FlxUINumericStepper.CHANGE_EVENT, iconOffsetY, null); 

		iconScaleStepper = new FlxUINumericStepper(280, decideIconColor.y + 80, 0.1, 1, 0.1, 5, 1);
		getEvent(FlxUINumericStepper.CHANGE_EVENT, iconScaleStepper, null); 
		...
		tab_group.add(iconScaleStepper);
	...
	override function update(elapsed:Float)
	{
		...
		var inputTexts:Array<FlxUIInputText> = [animationInputText, imageInputText, healthIconInputText, animationNameInputText, animationIndicesInputText, characterDeathName, characterDeathSound, characterDeathConfirm, characterDeathMusic, animationImageInputText];
	...
	//now shared with stageeditorstate
