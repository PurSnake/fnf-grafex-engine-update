...
class LoadingState extends MusicBeatState
{
    ...
    public static var amTake:Bool = false;
	public static var weekName:String = 'week1';
	public static var weekState:String = 'normal';
	...
	override function create()
	{
		...
		var greatPath = Paths.getPath('images/loadings/$weekName-$weekState.png', IMAGE);

		funkay = new FlxSprite(0, 0).loadGraphic(greatPath);
